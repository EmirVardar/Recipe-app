...
public class RecipeController {
    ...
    @GetMapping
    public ResponseEntity<List<RecipeListItemDto>> listRecipes(@RequestParam(required = false) String q) {
        return ResponseEntity.ok(recipeQueryService.listRecipes(q));
    }
